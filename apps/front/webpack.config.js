...
module.exports = {
  ...
  plugins: [
    ...
    new webpack.DefinePlugin({
      'process.env': {
        BUGSNAG_API_KEY: JSON.stringify(getSetting('BUGSNAG_API_KEY')),
        ...
        PROTECTED_BASE_URL: JSON.stringify(
          __DEV__ ? 'http://localhost:3000/' : getSetting('PROTECTED_BASE_URL')
        ),
      },
    }),
