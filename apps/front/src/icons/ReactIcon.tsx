export function ReactIcon() {
  return (
    <svg
      ...
      xmlSpace="preserve"
    >
      <style>{'.prefix__st0{fill:#fff}.prefix__st1{fill:#008aff}'}</style>
      <path
